...
gs_creds_text = st.sidebar.text_area(
    "Service Account JSON",
    height=150,
    help="Paste the Google service account credentials JSON."
)
gs_spreadsheet_id = st.sidebar.text_input(
    "Spreadsheet ID",
    help="The Google Sheets ID (the long hash in the sheet URL)."
)
gs_refs_sheet = st.sidebar.text_input(
    "References sheet name",
    value="ReferencesBySource"
)
gs_links_sheet = st.sidebar.text_input(
    "Links sheet name",
    value="SourceLinks"
)
